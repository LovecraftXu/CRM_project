...
<form action="systemset/Role_save" method="post" onsubmit="return check()">
<table class="query_form_table" cellSpacing=1 cellPadding=1>
	...
	<tr>
		<th>角色编号</th>
		<td><input  readonly="readonly" name="roleId" value="${count}"/></td>
	...
	<tr>
		...
		<th>角色状态</th>
		<td><input type="text" name="roleFlag" /><span class="red_star">*</span></td>
	</tr>	
	<tr>
		<th>创建人</th>
		<td><input  value="${username }" readonly size="20" /><span class="red_star">*</span></td>
	</tr>
	<tr>
    	<td width=100% height=32 align=center colspan=6 bgcolor=#ffffff>
        	<a href="help"><input class="common_button"  type="button" value="帮助"></a>
        	&nbsp;&nbsp;&nbsp;
			<a href="systemset/role_manage"><input class="common_button"  type="button" value="返回"></a>
&nbsp;&nbsp;
