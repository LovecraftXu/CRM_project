...
<body>
   <table width="100%" cellSpacing=0 cellPadding=0 border="0px">
	...
	<form action="systemset/role_update" method="post">
		<table class="query_form_table" cellSpacing=1 cellPadding=1>
			...
			<tr>
				...
				<td><input readonly="readonly" name="roleId" type="text"
					value="${sysRole.roleId }" /></td>
			</tr>
			<tr>
				<th>角色名</th>
				<td><input type="text" name="roleName"
					value="${sysRole.roleName }" /><span class="red_star">*</span></td>

			</tr>
			<tr>
				<th>描述</th>
				<td><textarea cols="50" rows="4" name="roleDesc"></textarea><span
