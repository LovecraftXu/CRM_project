...
<form action="systemset/User_save" method="post" onsubmit="return check()">
<table class="query_form_table" cellSpacing=1 cellPadding=1>
	...
	<tr>
		<th>用户编号</th>
		<td><input  readonly="readonly" name="usrId" value="${count}"/></td>
		<th>用户名</th>
		<td>
	...
	<tr>
    	<td width=100% height=32 align=center colspan=6 bgcolor=#ffffff>
        	...
        	&nbsp;&nbsp;&nbsp;
			<a href="systemset/user_manage"><input class="common_button"  type="button" value="返回"></a>
&nbsp;&nbsp;
