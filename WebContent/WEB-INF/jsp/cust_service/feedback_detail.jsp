...
<body>
    &nbsp;  
		...
		<br />
		<form action="cust_service/feedback_update" method="post" >
		<input type="hidden" name="svrId" value="${service.svrId }" />
		<input type="hidden" name="svrStatus" id="svr_status" value="已归档"/>
			<table class="query_form_table" id="table2" >
				<tr>
					...
					<select name="svrSatisfy" id="cs.svr_satisfy">
							<option value="${service.svrSatisfy }" selected="selected">
								--请选择--
							</option>
							<option value="5">
								☆☆☆☆☆
