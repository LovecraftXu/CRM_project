...
<form action="cust_info/activities_save" method="post" id="addatvform">
<input type="hidden" name="atvId" value="${count }"/>
<input type="hidden" name="atvCustNo" value="${count }"/>
<input type="hidden" name="atvCustId" value="${atvCustId }"/>
