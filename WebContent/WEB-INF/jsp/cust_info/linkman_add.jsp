...
<form action="cust_info/savelinkman" method="post" onsubmit="return linkman_addcheck()">

<div class="button_bar">
	<a href="help"><input class="common_button"  type="button" value="帮助"></a>
	<input type="submit" value="保存/返回" /> 
</div>
<input type="hidden" name="lkmId" value="${count }"/>
<input type="hidden" name="lkmCustId" value="${lkmCustId }"/>
