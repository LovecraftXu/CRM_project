...
<body>
  ...
  <div class="page_title">客户信息管理 &gt; 客户信息</div>
	...
	<form action="cust_info/update_customer" method="post" >
		...
		<table class="query_form_table">
			<tr>
				<th>客户编号</th>
				<td><input  name="custNo"
					value="${customer.custNo }" /></td>
				<th>名称</th>
				<td><input name="custName" value="${customer.custName }"
			...
			<tr>
				...
				<td><select name="custManagerName">
						<option selected="selected"
							value="${customer.custManagerName }"></option>
				</select> <span class="red_star">*</span></td>
			</tr>
			<tr>
				<th>客户等级</th>
		...
		<table class="query_form_table" id="table1">
			<tr>
				<th>地址</th>
				<td><input name="cust_addr" id="custAddr"
		...
		<table class="query_form_table" id="table2">
			...
			<tr>
				...
				<td><select name="custStatus">
						...
						<option selected="selected" value="${customer.custStatus }">正常</option>
				</select>
			</tr>
		</table>
	</form>
